...
import com.example.arvostelija.databinding.ActivityStorageBinding
...
class StorageActivity : AppCompatActivity() {
    ...
    private fun deleteImage(filename: String) = CoroutineScope(Dispatchers.IO).launch {
        try {
            ...
            // imageRef.child("Images/arvostelija-Image/$filename").delete().await()
            withContext(Dispatchers.Main) {
    ...
    private fun selectImage() {
        val intent = Intent()
        intent.type = "image/*"
        // intent.type = "Pictures/arvostelija-Image/*"
